...
$q = "UPDATE `notifications` SET notification1='$note1' WHERE not_id=1 ";
        mysqli_query($dbc,$q);
...
<body>
	<section>
<div>
<h1 style="text-align:center;">Notification 1</h1><br><br>
<div class="container">
<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
<div class="form-group row">
<label class="control-label">Notification:</label><br>
<textarea name="note1" rows="10" style="width:100%"></textarea>
</div>
